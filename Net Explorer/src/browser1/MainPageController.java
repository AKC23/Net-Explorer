...
public class MainPageController implements Initializable {
    ...
    @FXML
    private TextField userUrlField;                                             //userUrlField upward
    @FXML
...
//    private String homeUrl = "https://www.google.com/";                           //home page url
    private String homeUrl = "https://www.bing.com/";                           //home page url
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        userUrlField.setText(homeUrl);                                          //will show homeUrl first
        lastUrl = homeUrl;
        ...
        backwardButton.setOnAction(e -> engine.getHistory().go(-1));            //work of backward button
        forwardButton.setOnAction(e -> engine.getHistory().go(1));              //work of forward button
        ...
        bookmarksButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    scene.getStylesheets().add(getClass().getResource("bookmarks.css").toExternalForm());
